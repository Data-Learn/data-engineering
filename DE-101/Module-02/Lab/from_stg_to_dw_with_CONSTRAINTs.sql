...
(
 ...
 CONSTRAINT "FK_sales_fact_order_date"	FOREIGN KEY ( "order_date_id" )	REFERENCES "dw"."calendar_dim" ( "dateid" ),
 CONSTRAINT "FK_sales_fact_ship_date"	FOREIGN KEY ( "ship_date_id" )	REFERENCES "dw"."calendar_dim" ( "dateid" ),
 CONSTRAINT "FK_sales_fact_custumer"	FOREIGN KEY ( "cust_id" )		REFERENCES "dw"."customer_dim" ( "cust_id" ),
 CONSTRAINT "FK_sales_fact_geo"		FOREIGN KEY ( "geo_id" )		REFERENCES "dw"."geo_dim" ( "geo_id" ),
 CONSTRAINT "FK_sales_fact_products"	FOREIGN KEY ( "prod_id" )		REFERENCES "dw"."product_dim" ( "prod_id" ),
 CONSTRAINT "FK_sales_fact_ship"		FOREIGN KEY ( "ship_id" )		REFERENCES "dw"."shipping_dim" ( "ship_id" )
 );
CREATE INDEX "fkIdx_calendar_dim_order"	ON "dw"."sales_fact" ( "order_date_id");
CREATE INDEX "fkIdx_calendar_dim_ship"	ON "dw"."sales_fact" ( "ship_date_id");
CREATE INDEX "fkIdx_customer_dim"		ON "dw"."sales_fact" ( "cust_id");
CREATE INDEX "fkIdx_geo_dim"		ON "dw"."sales_fact" ( "geo_id");
CREATE INDEX "fkIdx_product_dim"		ON "dw"."sales_fact" ( "prod_id");
CREATE INDEX "fkIdx_shipping_dim"		ON "dw"."sales_fact" ( "ship_id");
