...
Также я записал еще два важных подкаста, которые помогут вам узнать понять лучше как работает рынок и чего ожидать, лучше спланировать свои цели:
...
2. Вы подаете в телеграмм канал [Data Learn](https://t.me/datalearn_chat/) в котором есть удобная навигация по модулям (пока что по Инжинирингу Данных и BI). Вам там ответят на любой вопрос!
