...
## Подключение к Терадате через Terada CLI(BTEQ)
...
На этом все. Поздравляем с успешным выполнением этой лабораторной работы!
