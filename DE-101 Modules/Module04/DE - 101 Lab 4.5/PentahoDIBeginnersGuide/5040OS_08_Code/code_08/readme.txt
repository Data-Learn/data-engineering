...
Here you have:
- A folder named pdi_labs with the transformation files developed in chapter 8
- A folder named pdi_files with sample files for the tutorials of chapter 8
- A folder named scripts with thw sql files scripts for the creation of the sample databases
